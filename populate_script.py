...
def populate():
    ...
    Reptiles = [
        ...
        },
        {
            ...
            "category": "Reptiles",
            "size": "The black mamba is a long, slender, cylindrical snake. It has a coffin-shaped head with a somewhat pronounced brow ridge and a medium-sized eye.The adult snake's length typically ranges from 2 to 3 m (6 ft 7 in to 9 ft 10 in) but specimens have grown to lengths of 4.3 to 4.5 m (14 ft 1 in to 14 ft 9 in). It is the longest species of venomous snake in Africa and the second-longest venomous snake species overall, exceeded in length only by the king cobra. The black mamba is a proteroglyphous (front-fanged) snake, with fangs up to 6.5 mm (0.26 in) in length, located at the front of the maxilla.The tail of the species is long and thin, the caudal vertebrae making up 17–25% of its body length.The body mass of black mambas has been reported to be about 1.6 kg (3.5 lb),although a study of seven black mambas found an average weight of 1.03 kg (2.3 lb), ranging from 520 g (1.15 lb) for a specimen of 1.01 m (3 ft 4 in) total length to 2.4 kg (5.3 lb) for a specimen of 2.57 m (8 ft 5 in) total length.",
